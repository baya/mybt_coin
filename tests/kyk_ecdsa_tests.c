...
char* test_kyk_ec_sign_hash256()
{
    ...
    uint8_t priv_bytes[32] = {
	0xca, 0x13, 0x2b, 0xc7, 0xf0, 0xed, 0xe8, 0x22,
	0xd8, 0xfb, 0x6c, 0x8d, 0x54, 0x14, 0x76, 0xb7,
	0xd7, 0x44, 0xcb, 0xb1, 0x63, 0xf2, 0x26, 0x1a,
	0x4f, 0x86, 0x88, 0x96, 0x5e, 0xf2, 0x08, 0xd9
    };
    ...
    uint8_t pubkey[33] = {
	0x02, 0x91, 0x55, 0x34, 0xbd, 0xa3, 0x76, 0xd6,
	0x02, 0x21, 0x17, 0xfd, 0x27, 0xd2, 0xcd, 0x9f,
	0x2f, 0x8e, 0x0d, 0xf5, 0x4f, 0xe6, 0x56, 0x79,
	0xc0, 0x70, 0xc1, 0x5d, 0x00, 0xbd, 0xbe, 0x4c,
	0xfb
    };
...
char* test2_kyk_ec_sign_hash256()
{

    uint8_t priv_bytes[32] = {
	0xe8, 0x2e, 0xd8, 0x37, 0x2c, 0xc9, 0x6e, 0x31,
	0x09, 0x3e, 0x5b, 0x94, 0xcc, 0x21, 0xaa, 0xe6,
	0x8c, 0xce, 0x4c, 0xb6, 0x20, 0xd5, 0x28, 0x7e,
	0xd1, 0xb0, 0xcd, 0x27, 0x3c, 0xc1, 0x12, 0xa9
    };
    
    uint8_t pubkey[33] = {
	0x03, 0x44, 0xc5, 0x28, 0x5f, 0xab, 0x34, 0x7d,
	0xcd, 0xa9, 0xa8, 0x12, 0xde, 0xf3, 0xe5, 0x07,
	0xa9, 0xf1, 0x57, 0x25, 0x6b, 0x7e, 0x04, 0x4e,
	0xa4, 0x5f, 0x55, 0xc6, 0xb3, 0x2e, 0xe2, 0xe2,
	0xeb	
    };
    ...
    uint8_t message[] = {
	
    };

    int res = -1;

    res = kyk_ec_sign_hash256(priv_bytes, message, sizeof(message), &sig_buf, &sig_buf_len);
    mu_assert(res == 0, "Failed to test_kyk_ec_sign_hash256");

    res = kyk_ec_sig_hash256_verify(message, sizeof(message),
				    sig_buf, sig_buf_len,
				    pubkey, sizeof(pubkey));
...
char *all_tests()
{
    ...
    mu_run_test(test2_kyk_ec_sign_hash256);
